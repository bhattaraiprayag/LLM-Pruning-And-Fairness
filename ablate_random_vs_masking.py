...
def evaluate(args, task_name, data_dir, model, tokenizer, head_mask=None):
    ...
    for eval_task in eval_task_names:
        ...
        if eval_task in ["mnli", "mnli-mm"] and args.model_type == "roberta":
...
def main():
    ...
    parser.add_argument(
        "--include_predictions", action="store_true",
        help="Set this flag if you want to save the predictions for the experiment.",
    )
    parser.add_argument(
        "--models_dir",
        default=None,
