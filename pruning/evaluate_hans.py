...
# This DataLoader can be used in the evaluation loop to iterate over batches of data and obtain model predictions
logger = logging.getLogger(__name__)


def create_eval_loader(data_dir, max_seq_length, model_type, model_name_or_path, tokenizer, overwrite_cache,
                       eval_batch_size):
    eval_dataset, label_list = load_and_cache_examples(data_dir, max_seq_length, model_type, model_name_or_path,
                                                       tokenizer, overwrite_cache)
