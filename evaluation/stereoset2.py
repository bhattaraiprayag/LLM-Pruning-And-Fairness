# Adapted from experiments/stereoset_evaluation.py in https://github.com/McGill-NLP/bias-bench
...
if __name__ == "__main__":
    ...
    if args.predictions_dir is not None:
        ...
        for prediction_file in glob.glob(predictions_dir + "*.json"):
            ...
            parse_file(
                f"{args.persistent_dir}/evaluation/data/stereoset/test.json", prediction_file
            )
    else:
        parse_file(
            f"{args.persistent_dir}/evaluation/data/stereoset/test.json", args.predictions_file
        )
