# From https://github.com/sunipa/On-Measuring-and-Mitigating-Biased-Inferences-of-Word-Embeddings/blob/master/generate_templates.py

import sys
from template_templates import Templates
from template_lists import Lists
import hashlib
import argparse
import csv

lists = Lists("evaluation/bias_nli/word_lists", None)
...
adj_template_warning = 'If adjective templates are used, this argument should be one of [' + ' '.join(
    adjective_types) + '].'
